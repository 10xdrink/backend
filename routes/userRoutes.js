 ...
 * @desc    Get a count of users grouped by active status
 * @access  Private/Admin
 */
router.get(
  "/admin/users/count-by-status",
  authMiddleware,
  adminMiddleware([USER_ROLES.SUPER_ADMIN, USER_ROLES.MARKETING_MANAGER]),
...
// Add a test route for user creation
/**
 * @route   POST /api/users/test-create
 * @desc    Test endpoint to create a user without authentication
