...
const getAllProductsValidation = [
  ...
  query("stockMin")
    .optional()
    .isInt({ min: 0 })
    .withMessage("stockMin must be a non-negative integer"),
  query("stockMax")
    .optional()
    .isInt({ min: 0 })
    .withMessage("stockMax must be a non-negative integer"),
  query("dateStart")
    .optional()
    .isISO8601()
    .withMessage("dateStart must be a valid ISO date"),
  query("dateEnd")
    .optional()
    .isISO8601()
    .withMessage("dateEnd must be a valid ISO date"),
  query("isActive")
    .optional()
    .isBoolean()
  ...
  query("sortDirection")
    .optional()
    .isIn(["1", "-1", 1, -1])
    .withMessage("sortDirection must be 1 or -1"),
  validateMiddleware,
];
